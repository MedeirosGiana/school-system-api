...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Curso curso1 = new Curso(null,"Ciencias de Dados",1500,12000.00,7.0);
        Curso curso2 = new Curso(null,"Contabilidade",1400,15000.000,7.0);
        Curso curso3 = new Curso(null,"Engenharia",2000,24000.000,7.0);
        Curso curso4 = new Curso(null,"Recursos Humanos",1500,16000.000,7.0);
        ...
        Avaliacao aluno1 = new Avaliacao((Integer) null,6.0,Instant.parse("2019-07-05T10:20:07Z"),a1);
        Avaliacao aluno2 = new Avaliacao((Integer) null,8.0,Instant.parse("2019-08-05T10:20:07Z"),a2);
        Avaliacao aluno3 = new Avaliacao((Integer) null,6.5,Instant.parse("2019-09-05T10:20:07Z"),a3);
        ...
        avaliacaoRepository.saveAll(Arrays.asList(aluno1,aluno2,aluno3));
